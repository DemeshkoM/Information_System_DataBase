...
public class ProviderRecipeListUpdateIngredientRecipeController implements InsertController, Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        idChoiceBox.setDisable(true);
        idRecipeChoiceBox.setDisable(true);
    }
